ethplorerWidget = {
    ...
    appendEthplorerLink: function(obj){
        ...
        if(document.location.host !== host){
            ...
            obj.el.append(divLink + '<a class="tx-link" style="text-decoration: dashed;" href="javascript:void(0)" onclick="ethplorerWidget.getWidgetCode(this);">Get widget code</a></div>');
