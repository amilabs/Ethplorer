ethplorerWidget = {
    ...
    appendEthplorerLink: function(obj){
        ...
        if((document.location.host !== host) && (document.location.host.indexOf("amilabs.cc") < 0)){
            ...
            obj.el.append(divLink + '<a class="widget-code-link" style="text-decoration-line: underline !important;" href="javascript:void(0)" onclick="ethplorerWidget.getWidgetCode(this);">Get widget code</a></div>');
