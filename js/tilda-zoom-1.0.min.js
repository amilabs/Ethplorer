function t_initZoom(){if($('[data-zoomable="yes"]').length){$('[data-zoomable="yes"]').addClass("t-zoomable");$("body").append('<div class="t-zoomer__wrapper">\
    ...
    </div>');t_showZoom();$(document).keydown(function(e){if(e.keyCode==27){$('body').removeClass("t-zoomer__show");$('body').removeClass("t-zoomer__show_fixed")}});$('.t-zoomer__close, .t-zoomer__bg').click(function(e){$('body').removeClass("t-zoomer__show");$('body').removeClass("t-zoomer__show_fixed")})}}
